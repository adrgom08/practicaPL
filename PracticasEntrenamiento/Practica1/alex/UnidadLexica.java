...
public class UnidadLexica extends Symbol {
    public UnidadLexica(int fila, int columna, String clase) {
	super(clase,new TokenValue(fila,columna));
    }
    public UnidadLexica(int fila, int columna, String clase, String lexema) {
	super(clase,new TokenValue(lexema,fila,columna));
    }
    public String clase () {return sym;}
